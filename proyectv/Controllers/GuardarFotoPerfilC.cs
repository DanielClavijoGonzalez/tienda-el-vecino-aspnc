...
{
    public class GuardarFotoPerfilC : Controller
    {
        ...
        string rutaDImagen;
        public GuardarFotoPerfilC(IWebHostEnvironment env)
        {
            _env = env;
        ...
        {
            #region Content
            if (imagenDP == null) return Redirect("/Cliente");
